...
using TrainingManagement.Repositories;
...
namespace TrainingManagementProjectTry
{
    public class Startup
    {
        ...
        public void ConfigureServices(IServiceCollection services)
        {
            ...
            services.AddTransient<IUtilityManager, StudentDropDownUtitily>();
            ...
            services.AddCors(c => c.AddPolicy("AllowOrign", opt =>
                {
                    opt.AllowAnyHeader();
                    opt.AllowAnyOrigin();
                }
